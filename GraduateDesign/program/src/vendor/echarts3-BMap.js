/**
 * echarts3 百度地图扩展，必须在echarts3初始化前使用
 *
 ...
 */
    ...
    BMapExt.prototype._init = function (obj, BMap, ec, mapOption) {
        ...
        self.initECharts = function () {
            ...
            self._ec.Geo.prototype.dataToPoint = function(e) {
                var i = new BMap.Point(e[0], e[1]), r = n._map.pointToOverlayPixel(i);
                return [r.x, r.y]
            };
            self._bindEvent();
            self._addMarkWrap();
